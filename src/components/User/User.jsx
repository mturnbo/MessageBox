...
const User = (userData) => {
  ...
  return <div
    ...
    <div className="flex flex-col items-center pb-10">
      <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="/public/assets/images/profile58.jpg"
           alt="Bonnie image"/>
      <h4 className="mb-1 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">{ username }</h4>
